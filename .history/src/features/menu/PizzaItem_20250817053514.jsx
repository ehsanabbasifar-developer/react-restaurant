          ...
          <div className="flex justify-between w-full">
            {isSelected ? (
              <div className="flex gap-x-1">
                <button className='bg-yellow-400 rounded-full p-2 font-bold'>حذف</button>
                <div>
                <button className='bg-yellow-400 rounded-full p-2 font-bold'>-</button>
                  <span className="font-bold mx-3">{data.number}</span>
<button className='bg-yellow-400 rounded-full p-2 font-bold'>{children}</button>                </div>{" "}
              </div>
            ) : (
              <button
                type="click"

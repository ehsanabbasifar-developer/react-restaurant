  ...
  return (
    <form className="font-Vazirmatn flex flex-col gap-y-2">
      ...
      <div className="flex flex-col">
        ...
        <textarea className="bg-yellow-300 resize-none text-r outline-yellow-500 text-gray-500" />
      </div>
      ...
      <Link className="text-right" to={"/login"}>قبلا ثبت نام کرده اید ؟ ورود</Link>
    </form>
  );
}

    ...
    <form className="font-Vazirmatn flex gap-x-4 ">
      ...
      <div className="flex flex-col gap-y-2">
        ...
        <input
          ...
          className="bg-yellow-300 rounded-full  outline-yellow-500  text-gray-500 text-center"
        />
        <textarea className="bg-yellow-300 resize-none  outline-yellow-500 text-gray-500" />
        <button type="submit" className="bg-yellow-400 rounded-full text-gray-600 w-auto" >ثبت نام</button>
      </div>
    </form>
  );
}

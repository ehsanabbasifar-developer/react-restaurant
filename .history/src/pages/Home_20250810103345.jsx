...
با هر اسلایس، عطر و طعمی که فراموش نخواهید کرد را تجربه کنید.`}
          ...
          <IntroLayout
            buttonMessage={"ورود"}
            description={`در رستوران ری‌اکت اصفهان، کیفیت و رضایت شما اولویت ماست. محیطی تمیز و لاکچری فراهم کرده‌ایم تا تجربه‌ای بی‌نظیر از صرف غذا داشته باشید. با تیم حرفه‌ای و سرویس‌دهی سریع، زمان انتظار شما به حداقل ممکن رسیده است تا بدون دغدغه از طعم لذیذ پیتزای ما لذت ببرید. رضایت شما، انگیزه ماست!`} img={"./pizza3.jpg"}
          />
        </>
      </Main>
    </AppLayout>
